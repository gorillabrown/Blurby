...
**Last updated**: 2026-05-23 — READER-PERSISTENT-ANCHOR Step 3.4 manual QA: S12 start-word FIXED (verified), but S13 cursor/audio sync still fails; Step 3.5 / NARRATE-CURSOR-SYNC-4 is the active blocker before READER-ISO-1A.
**Current state**: v1.75.1 stable baseline plus committed Phase 0, governance sweep, roadmap queue recovery, and broad-suite drift triage. The reader persistent-anchor hotfix branch remains unmerged; Step 3.1 commit `e6ebb07` fixed S1, S4, and S18 and improved S5, Step 3.2 commit `bb00e17` fixed S8 Flow double-cursor and improved Narrate chunk-boundary continuity, Step 3.3 commits `881b01d` and `48c23ac` fixed a double-`resyncToCursor` active-click race plus cold-start sentence/ramp issues, and Step 3.4 commit `2142d4a` implemented content-alignment stamping from canonical extractor words so click indexes and TTS indexes share one word space by construction. S9 Flow lazy-follow remains intentionally deferred as high-risk. Step 3.4 manual QA confirmed the S12 start-word fix but exposed a residual S13 defect (the visual cursor outruns the audio and the narration skips forward at chunk-load); Step 3.5 / NARRATE-CURSOR-SYNC-4 (clamp cursor to the playing source) is the active blocker before adapter isolation. Kokoro is the sole active local/cacheable model engine; Web Speech remains a platform fallback. MOSS-Nano and Pocket TTS are dormant/disabled; Qwen retired/disabled.
**Finish line**: TTS Quality Confidence + Reading Experience v2 — narration UX polish + quality regression gates.
**Queue**: GREEN (depth 9). 5 full specs + 4 stubs. Active gate: READER-PERSISTENT-ANCHOR Step 3.5 / NARRATE-CURSOR-SYNC-4 (cursor-vs-audio sync repair).
**Last sprint**: TEST-GREEN-1 (2026-05-22) — classified and resolved 12 broad-suite failures before adapter extraction. Latest branch close-out: READER-PERSISTENT-ANCHOR Step 3.4 manual-QA PARTIAL (S12 fixed, S13 open); Step 3.5 specced; branch still not main-landed.
...
- **Source:** Step 2 manual QA report; Step 2 close-out; Step 3, Step 3.1, Step 3.2, and Step 3.3 manual QA reports; Step 3.2, Step 3.3, and Step 3.4 closeouts; SRL-053; SRL-054; SRL-055; SRL-060; SRL-061; SRL-062; SRL-063; SRL-064; SRL-065; SRL-066; SRL-067; SRL-068.
