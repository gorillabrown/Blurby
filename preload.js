...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  kokoroPreflight: () => ipcRenderer.invoke("tts-kokoro-preflight"),
  ...
  nanoStatus: () => ipcRenderer.invoke("tts-nano-status"),
  nanoSynthesize: (payload) => ipcRenderer.invoke("tts-nano-synthesize", payload),
  nanoCancel: (requestId) => ipcRenderer.invoke("tts-nano-cancel", requestId),
  nanoShutdown: () => ipcRenderer.invoke("tts-nano-shutdown"),
  nanoRestart: () => ipcRenderer.invoke("tts-nano-restart"),
  pocketStatus: () => ipcRenderer.invoke("tts-pocket-status"),
  pocketSynthesize: (payload) => ipcRenderer.invoke("tts-pocket-synthesize", payload),
  pocketCancel: (requestId) => ipcRenderer.invoke("tts-pocket-cancel", requestId),
  pocketShutdown: () => ipcRenderer.invoke("tts-pocket-shutdown"),
  pocketRestart: () => ipcRenderer.invoke("tts-pocket-restart"),
  ...
  ttsCacheWrite: (bookId, voiceId, startIdx, audioArr, sampleRate, durationMs, wordCount, timingMetadata) =>
    ipcRenderer.invoke("tts-cache-write", bookId, voiceId, startIdx, audioArr, sampleRate, durationMs, wordCount, timingMetadata),
