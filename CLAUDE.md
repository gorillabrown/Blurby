...
## Current System State (v1.75.1 — queue GREEN depth 6 [4 full specs + 2 stubs], 3 open bugs)
...
- **Queue:** GREEN depth 6 (4 full specs at positions 1-4: EXT-PAIR-1, SINGLE-INSTANCE-LOCK-1, THEME-SYNC-1, NARRATE-CLOSED-LOOP-CURSOR; 2 stubs at positions 5-6: UX-POLISH-1, HYG-XLSX-DASHBOARD-RESTORE) in `docs/governance/sprint-queue.xlsx`. Next: EXT-PAIR-1 — Chrome extension pairing auth timeout repair. EXT-PAIR-1 + SINGLE-INSTANCE-LOCK-1 + THEME-SYNC-1 are hotfix sprints (BUG-183, F1, BUG-182). NARRATE-CLOSED-LOOP-CURSOR is the sole shared-core sprint and must run alone.
...
- **Most recent sprint:** TTS-QUAL-CI-1 — CI regression gate wiring + recalc.py governance tooling (2026-05-28).
