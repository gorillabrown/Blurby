...
- Active queue: GREEN — MOSS-NANO-13c is next, but not started. Desktop v2.0 conveyor active; MOSS-NANO-13c is dispatch-ready, while 13d, 13e, POLISH-1, and RELEASE-1 remain stage stubs to harden later. KOKORO-RETIRE remains deferred even if the MOSS-NANO lane eventually records `NANO_RECOMMENDED_OPT_IN`.
