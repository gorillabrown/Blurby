...
- **Queue pointer** — `docs/governance/sprint-queue.xlsx` is the authoritative queue source. Queue depth is RED at 2 (0 full specs + 2 stubs): UX-POLISH-1 → TTS-QUAL-CI-1. /roadmap-review required before next dispatch. TTS-EVAL-3 is complete and landed.
