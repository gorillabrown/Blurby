...
- **Queue:** GREEN depth 5 (4 full specs at positions 1-4: EXT-PAIR-1, SINGLE-INSTANCE-LOCK-1, THEME-SYNC-1, NARRATE-CLOSED-LOOP-CURSOR; 1 stub at position 5: UX-POLISH-1) in `docs/governance/sprint-queue.xlsx`. Next: EXT-PAIR-1 — Chrome extension pairing auth timeout repair. EXT-PAIR-1 + SINGLE-INSTANCE-LOCK-1 + THEME-SYNC-1 are hotfix sprints (BUG-183, F1, BUG-182). NARRATE-CLOSED-LOOP-CURSOR is the sole shared-core sprint and must run alone.
