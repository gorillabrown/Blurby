...
const SECTIONS: ShortcutSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { keys: ["Ctrl", "←"], description: "Seek -1 word" },
      { keys: ["Ctrl", "→"], description: "Seek +1 word" },
      { keys: ["Ctrl", "↑"], description: "Previous sentence" },
      { keys: ["Ctrl", "↓"], description: "Next sentence" },
      { keys: ["Shift", "←"], description: "Previous paragraph" },
      { keys: ["Shift", "→"], description: "Next paragraph" },
      { keys: ["Shift", "↑"], description: "Previous chapter" },
      { keys: ["Shift", "↓"], description: "Next chapter" },
  ...
  },
  {
    ...
    rows: [
      ...
      { keys: ["←"], description: "Rewind 5 words" },
      { keys: ["→"], description: "Forward 5 words" },
      { keys: ["Ctrl", "←"], description: "Seek -1 word" },
      { keys: ["Ctrl", "→"], description: "Seek +1 word" },
      { keys: ["Ctrl", "↑"], description: "Previous sentence" },
      { keys: ["Ctrl", "↓"], description: "Next sentence" },
