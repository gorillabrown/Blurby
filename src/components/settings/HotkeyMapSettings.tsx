...
const SECTIONS: Array<{ title: string; shortcuts: ShortcutEntry[] }> = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { action: "Jump back", key: "Left Arrow" },
      { action: "Jump forward", key: "Right Arrow" },
      { action: "Speed up (fine)", key: "Up Arrow" },
      { action: "Slow down (fine)", key: "Down Arrow" },
      { action: "Speed up (coarse)", key: "Shift + Up" },
      { action: "Slow down (coarse)", key: "Shift + Down" },
      { action: "Star / Favorite", key: "S" },
      { action: "Toggle narration", key: "T" },
      { action: "Switch reading mode", key: "Shift + F" },
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { action: "Exit reader", key: "Esc (double)" },
    ],
  },
  {
    title: "Overlays",
