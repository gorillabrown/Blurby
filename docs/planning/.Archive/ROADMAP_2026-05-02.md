...
**Investigation report:** `docs/studies/investigations/SELECTION-1-investigation.md` — full trace of all 4 word lists, per-mode start resolution, navigation events, persistence, and 6 identified gaps.
...
3. `docs/studies/investigations/SELECTION-1-investigation.md` — full investigation report (MUST READ — contains all position flow diagrams and gap analysis)
...
**Investigation report:** `docs/studies/investigations/HOTFIX-14-investigation.md` — URL test results (5/5 pass with Node fetch), full `_clients` Set state diagram, three compounding root causes for false connected status.
...
Both BUG-155 and BUG-156 root causes confirmed. Full investigation at `docs/studies/investigations/HOTFIX-14-investigation.md`.
...
3. `docs/studies/investigations/HOTFIX-14-investigation.md` — MUST READ — full root cause analysis, state diagrams, fix specs
4. `ROADMAP.md` — this section
...
> Full spec archived to `docs/planning/.Archive/ROADMAP_legacy.md`. **Result:** All 16 success criteria met, 1,717 tests passing (18 new in `tests/narrTiming.test.ts`), build succeeds. v1.44.0. 2026-04-07.
...
1. `CLAUDE.md`
2. `docs/governance/LESSONS_LEARNED.md`
3. `docs/planning/specs/2026-04-17-four-mode-reader-and-narrate-restoration-design.md`
4. `ROADMAP.md` — this section
...
1. `CLAUDE.md`
2. `docs/governance/LESSONS_LEARNED.md`
3. `docs/planning/specs/2026-04-20-qwen-streaming-kokoro-backup-design.md` — MUST READ — the approved design this sprint implements Phase 1 of
4. `ROADMAP.md` — this section
...
1. `CLAUDE.md`
2. `docs/governance/LESSONS_LEARNED.md`
3. `docs/planning/specs/2026-04-20-qwen-streaming-kokoro-backup-design.md` — decision criteria
...
**Execution-ready plan:** [docs/planning/plans/2026-04-26-moss-flagship-operational-lane.md](C:/Users/estra/Projects/Blurby/docs/planning/plans/2026-04-26-moss-flagship-operational-lane.md)
