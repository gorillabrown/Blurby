...
- **Design spec:** `docs/planning/three-mode-reader-redesign.md`
...
- **Template**: `docs/planning/Reading_Log_Blurby_Template.xlsx` — match structure exactly
...
**Design spec references:** `docs/planning/three-mode-reader-redesign.md`, `docs/planning/hotkey-reference.md`
...
**Design spec:** `docs/planning/specs/2026-03-26-stabilization-sprint-design.md`
**Implementation plan:** `docs/planning/plans/2026-03-26-stabilization-sprint.md`
...
**Design spec:** `docs/planning/specs/2026-03-29-tts-pipeline-redesign-design.md`
...
3. `docs/planning/specs/2026-03-29-tts-pipeline-redesign-design.md` — **Full design spec with all architecture details, data flows, formulas, and edge cases. This is the primary reference.**
...
- **Design spec is authoritative.** The full design doc at `docs/planning/specs/2026-03-29-tts-pipeline-redesign-design.md` has all formulas, data flows, constants, edge cases, and error handling. Read it completely before starting any implementation. This ROADMAP spec is the dispatch — the design doc is the payload.
...
**Design spec:** `docs/planning/specs/2026-03-29-tts-pipeline-redesign-design.md` §Future Work — Phase 2
...
**Design spec:** `docs/planning/specs/2026-03-29-tts-pipeline-redesign-design.md` §Future Work — Phase 3
...
### EVIDENCE OF PROBLEM
- `docs/planning/AGENT_FINDINGS.md` §CRIT-1 — Full finding with file path and line numbers
...
3. `docs/planning/AGENT_FINDINGS.md` — Full audit findings (CRIT-1 details)
...
> **Note:** CT-3 and Sprint 24 run in PARALLEL. CT-3 fixes bugs (code changes). Sprint 24 audits the codebase (read-only). No file conflicts — Sprint 24 only writes to `docs/planning/AGENT_FINDINGS.md`. If the audit surfaces CRITICALs that overlap with CT-3 bugs, they're already being fixed. New CRITICALs from the audit get addressed in a remediation pass after both complete.
...
**Prerequisite:** Sprint CT-2 complete. Runs in PARALLEL with CT-3 (no file conflicts — audit writes only to `docs/planning/AGENT_FINDINGS.md`).
...
- Output: findings to `docs/planning/AGENT_FINDINGS.md`
...
- All findings in `docs/planning/AGENT_FINDINGS.md` with severity ratings
