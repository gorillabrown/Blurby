...
- research spec: `docs/planning/specs/`
- candidate notes: `docs/studies/research/tts-engine-scan/`
- audio comparison artifacts: `artifacts/tts-eval/engine-scan/`
- final decision memo: `docs/studies/research/tts-engine-scan/FINAL_RECOMMENDATION.md`
