...
- Modify: `docs/planning/desktop-v2.0-release-notes.md`
- Modify: `docs/planning/desktop-v2.0-release-checklist.md`
- Modify: `ROADMAP.md`
...
```powershell
git grep -n -E "1\\.75\\.0|1\\.75\\.1|closeout candidate|release candidate|Desktop v2\\.0" package.json package-lock.json ROADMAP.md docs/planning docs/governance
```
...
- Modify: artifact docs under `docs/testing/` and `docs/planning/`
- Modify or create: `docs/studies/audit/postv2-structural-debt-map.md`
...
- [ ] **Step 1: Create `docs/studies/audit/postv2-structural-debt-map.md`.**
...
Plan complete and saved to `docs/planning/plans/2026-05-04-postv2-audit-remediation.md`. Two execution options:
