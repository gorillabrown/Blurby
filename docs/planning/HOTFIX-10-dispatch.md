...
### EVIDENCE OF PROBLEM
Console shows narration starts at 6846→6978→7726 with no cursor advance during playback. Investigation: `docs/planning/HOTFIX-10-investigation.md`.
...
1. `docs/planning/HOTFIX-10-investigation.md` — Full root cause analysis and fix design
