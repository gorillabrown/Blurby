...
**WHERE (Read Order):**
1. `docs/studies/audit/audit-step1-initial-review.md` §E (MAIN-01, MAIN-04) and §F (MAIN-10, MAIN-11, MAIN-12) — finding details
2. `docs/studies/audit/AUDIT 1/AUDIT 1. 3RD PARTY REVIEW.md` §E (CRIT-2, CRIT-3) and §F (MAJ-3, MAJ-4) — external confirmation
...
**WHERE (Read Order):**
1. `docs/studies/audit/audit-step1-initial-review.md` §E (MAIN-02, MAIN-03, REND-03) and §F (MAIN-08, MAIN-18, REND-06)
...
**WHERE (Read Order):**
1. `docs/studies/audit/audit-step1-initial-review.md` §E (REND-01, REND-02, REND-04) and §F (REND-05, REND-07, REND-08)
...
**WHERE (Read Order):**
1. `docs/studies/audit/audit-step1-initial-review.md` §F (MAIN-05, MAIN-06, MAIN-07)
2. `docs/studies/audit/AUDIT 1/AUDIT 1. 3RD PARTY REVIEW.md` §F (MAJ-1, MAJ-2) — RFC citations
...
**WHERE (Read Order):**
1. `docs/studies/audit/audit-step1-initial-review.md` §F (TEST-03, TEST-04, TEST-05) and §H (TEST-12)
